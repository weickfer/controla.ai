      ...
      <div className="relative container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 bg-whatsapp rounded-2xl flex items-center justify-center shadow-glow">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-10">
            <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm border border-white/20">
              <Gift className="w-6 h-6 text-whatsapp mx-auto mb-2 drop-shadow-sm" />
              <div className="text-white font-medium text-sm drop-shadow-sm">Totalmente gratuito</div>
            </div>
            <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm border border-white/20">
              <MessageCircle className="w-6 h-6 text-whatsapp mx-auto mb-2 drop-shadow-sm" />
              <div className="text-white font-medium text-sm drop-shadow-sm">Direto no WhatsApp</div>
            </div>
            <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm border border-white/20">
              <Sparkles className="w-6 h-6 text-whatsapp mx-auto mb-2 drop-shadow-sm" />
          ...
          <div className="space-y-4">
            <Button 
              variant="whatsapp" 
              size="lg"
              className="text-lg px-12 group shadow-glow"
            ...
            <p className="text-white/90 text-sm drop-shadow-sm">
              Sem cadastro complicado • Sem cartão de crédito • Sem compromisso
            </p>
          </div>
